...
export class ConstructorComponent implements OnInit {
  ...
  usual_size() {
    ...
    this.height = 300;
    this.margin_top = 85;
    this.div_style = `width:${this.width}px; height:${this.height}px; margin-top:${this.margin_top}px; background-image: url(${this.background}); background-size: ${this.width}px ${this.height}px;`;
  }
  vertical_size() {
    this.width = 350;
    this.height = 480;
